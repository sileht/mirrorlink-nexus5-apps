...
.method public static privateToExplicitParameters(Ljava/security/PrivateKey;Ljava/security/Provider;)Ljava/security/PrivateKey;
    ...
    const-string/jumbo v1, "cannot convert GOST key to explicit parameters."

    invoke-direct {v0, v1}, Ljava/io/UnsupportedEncodingException;-><init>(Ljava/lang/String;)V

    throw v0
    :try_end_3e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_3e} :catch_3e
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_3e} :catch_ba
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_3e} :catch_bc
    ...
    invoke-direct {v0, v3, v1}, Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;-><init>(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;Lorg/bouncycastle/asn1/ASN1Encodable;)V
    ...
    :try_end_b9
    .catch Ljava/lang/IllegalArgumentException; {:try_start_40 .. :try_end_b9} :catch_3e
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_40 .. :try_end_b9} :catch_ba
    .catch Ljava/lang/Exception; {:try_start_40 .. :try_end_b9} :catch_bc
...
.method public static publicToExplicitParameters(Ljava/security/PublicKey;Ljava/security/Provider;)Ljava/security/PublicKey;
    ...
    :try_end_3e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_3e} :catch_3e
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_3e} :catch_be
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_3e} :catch_c0
    ...
    invoke-direct {v0, v2, v3, v4, v5}, Lorg/bouncycastle/asn1/x9/X9ECParameters;-><init>(Lorg/bouncycastle/math/ec/ECCurve;Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    :try_end_bd
    .catch Ljava/lang/IllegalArgumentException; {:try_start_40 .. :try_end_bd} :catch_3e
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_40 .. :try_end_bd} :catch_be
    .catch Ljava/lang/Exception; {:try_start_40 .. :try_end_bd} :catch_c0
