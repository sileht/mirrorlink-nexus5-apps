...
.method public generatePrivate(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
    ...
    instance-of v0, p1, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PrivateKeySpec;
    ...
    check-cast p1, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PrivateKeySpec;

    invoke-direct {v0, p1}, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/BCMcElieceCCA2PrivateKey;-><init>(Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PrivateKeySpec;)V
    ...
    :try_end_43
    .catch Ljava/io/IOException; {:try_start_3c .. :try_end_43} :catch_c3
    ...
    new-instance v9, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/BCMcElieceCCA2PrivateKey;

    new-instance v0, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PrivateKeySpec;

    const-string/jumbo v1, "1.3.6.1.4.1.8301.3.1.3.4.2"

    invoke-direct/range {v0 .. v8}, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PrivateKeySpec;-><init>(Ljava/lang/String;II[B[B[B[B[[B)V

    invoke-direct {v9, v0}, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/BCMcElieceCCA2PrivateKey;-><init>(Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PrivateKeySpec;)V
    :try_end_c2
    .catch Ljava/io/IOException; {:try_start_44 .. :try_end_c2} :catch_ee
    ...
    :try_end_ea
    .catch Ljava/io/IOException; {:try_start_de .. :try_end_ea} :catch_ee
...
.method public generatePrivate(Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;)Ljava/security/PrivateKey;
    ...
    invoke-virtual {v8}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PrivateKey;->getOID()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {v8}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PrivateKey;->getN()I

    move-result v2

    invoke-virtual {v8}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PrivateKey;->getK()I

    move-result v3

    invoke-virtual {v8}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PrivateKey;->getField()Lorg/bouncycastle/pqc/math/linearalgebra/GF2mField;

    move-result-object v4

    invoke-virtual {v8}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PrivateKey;->getGoppaPoly()Lorg/bouncycastle/pqc/math/linearalgebra/PolynomialGF2mSmallM;

    move-result-object v5

    invoke-virtual {v8}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PrivateKey;->getP()Lorg/bouncycastle/pqc/math/linearalgebra/Permutation;

    move-result-object v6

    invoke-virtual {v8}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PrivateKey;->getH()Lorg/bouncycastle/pqc/math/linearalgebra/GF2Matrix;

    move-result-object v7

    invoke-virtual {v8}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PrivateKey;->getQInv()[Lorg/bouncycastle/pqc/math/linearalgebra/PolynomialGF2mSmallM;
...
.method public generatePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
    ...
    instance-of v0, p1, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PublicKeySpec;
    ...
    check-cast p1, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PublicKeySpec;

    invoke-direct {v0, p1}, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/BCMcElieceCCA2PublicKey;-><init>(Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PublicKeySpec;)V
    ...
    new-instance v4, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PublicKeySpec;

    const-string/jumbo v5, "1.3.6.1.4.1.8301.3.1.3.4.2"

    invoke-direct {v4, v5, v2, v1, v0}, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PublicKeySpec;-><init>(Ljava/lang/String;II[B)V

    invoke-direct {v3, v4}, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/BCMcElieceCCA2PublicKey;-><init>(Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PublicKeySpec;)V
    :try_end_89
...
.method public generatePublic(Lorg/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)Ljava/security/PublicKey;
    ...
    new-instance v1, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/BCMcElieceCCA2PublicKey;

    invoke-virtual {v0}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PublicKey;->getOID()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/pqc/asn1/McElieceCCA2PublicKey;->getG()Lorg/bouncycastle/pqc/math/linearalgebra/GF2Matrix;

    move-result-object v0

    invoke-direct {v1, v2, v3, v4, v0}, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/BCMcElieceCCA2PublicKey;-><init>(Ljava/lang/String;IILorg/bouncycastle/pqc/math/linearalgebra/GF2Matrix;)V
    :try_end_23
...
.method public getKeySpec(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;
    ...
    const-class v0, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PrivateKeySpec;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/BCMcElieceCCA2PrivateKey;->getQInv()[Lorg/bouncycastle/pqc/math/linearalgebra/PolynomialGF2mSmallM;
    ...
    const-class v0, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PublicKeySpec;
    ...
    new-instance v0, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PublicKeySpec;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lorg/bouncycastle/pqc/jcajce/spec/McElieceCCA2PublicKeySpec;-><init>(Ljava/lang/String;IILorg/bouncycastle/pqc/math/linearalgebra/GF2Matrix;)V
